...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.radio_button_1 = ctk.CTkRadioButton(master=self.sidebar_frame, variable=self.radio_var, value=0)
        self.radio_button_1.grid(row=1, column=0, pady=10, padx=20, sticky="n")
        self.radio_button_2 = ctk.CTkRadioButton(master=self.sidebar_frame, variable=self.radio_var, value=1)
        ...
        self.seg_button_1 = ctk.CTkSegmentedButton(
        ...
        self.checkbox_2.grid(row=2, column=0, pady=(
            20, 0), padx=20, sticky="n")
        self.checkbox_3 = ctk.CTkCheckBox(
            master=self.checkbox_slider_frame)
